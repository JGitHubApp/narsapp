homePageAppLinkInfo = new AppLinkLog(
	[
		...
		['Hotels', 'images/icons/glossy-black-icon-business-home1.png', 'htdocs/hotels.html', '#11E'],
		['GI Bill Students', 'images/icons/glossy-black-icon-sports-hobbies-medal.png', 'http://www.jccc.edu/veterans/index.html', '#C00'],
		['Learning Tools', 'images/icons/glossy-black-icon-business-tools1.png', 'htdocs/learningTools.html', '#181'],
	...
	[
		...
		[],
		[],
		['programs', 'veterans', 'services', 'military'],
		[],
		[],
		[],
